"""Camada de Views/Routes — apenas declara as rotas e delega aos controllers.

Mantém o contrato dos endpoints originais. As rotas administrativas inseguras
(/admin/query e /admin/reset-db) foram REMOVIDAS por serem falhas CRITICAL.
"""
...
api.add_url_rule("/health", "health_check", relatorio_controller.health_check, methods=["GET"])
